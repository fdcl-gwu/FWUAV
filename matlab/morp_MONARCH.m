...
MONARCH.S = 2.46E-3/2; % area of the right wing
...
MONARCH.tilde_r_3 = 0.2*MONARCH.l; % non-dimensional radius of the thrid moment of wing area (arbitrary value)
...
MONARCH.tilde_r_v_1 =0.01; % non-dimensional radius of the first moment of wing volume (arbitrary value)
MONARCH.tilde_r_v_2 =0.01; % non-dimensional radius of the second moment of wing volume (arbitrary value)
