...
lb = [-pi/8, 0, 0, -pi/2, 0, 0, -pi/6, -pi/2, 0, -pi, -5*pi/180, -1, -1, -1, 0, -pi/4, -pi, WK.f*(1-0.15), -30*pi/180, -5];
ub = [pi/5, pi/2, 1, pi/2, 40*pi/180, 3, pi/6, pi/2, 5*pi/180, pi, 5*pi/180, 1, 1, 1, pi/12, pi/4, pi, WK.f*(1+0.15), 45*pi/180, 5];
...
ptmatrix(1, :) = [0.2950    0.8865    0.7242   -0.3732    0.5625    0.6328   -0.0129    0.3241    0.0419    0.2634   -0.0000    0.6994    0.0000   -0.6685 0.1648    0.0433    3.1416    9.3263 0 0];
