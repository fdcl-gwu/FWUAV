function [X_dot,R,Q_R,Q_L,Q_A,theta_B,theta_A,W,W_R,W_L,W_A,...
    ...
    eom_xR(INSECT,WK_R,WK_L,t,X,timeStep,SIM)
...
[Q_A,W_A,W_A_dot,theta_A] = abdomen_attitude(t,WK_R.f); %time-varying 
...
[L_R,L_L,D_R,D_L,M_R,M_L,F_rot_R,F_rot_L,M_rot_R,M_rot_L,alpha_R,alpha_L,U_alpha_R_dot,U_alpha_L_dot,U_R,U_L] = ...
    wing_QS_aerodynamics(SIM,INSECT,W_R,W_L,W_R_dot,W_L_dot,...
...
% xi_1_dot=(JJ_11-C*JJ_21)\(-tmp_1+tmp_2+tmp_f+u_control); %%% NO CONTROL
