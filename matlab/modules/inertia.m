...
JJ=zeros(15,15);
JJ(1:3,1:3) = 0.5*(INSECT.m_B*eye(3) + JJ_R(1:3,1:3) + JJ_L(1:3,1:3) + JJ_A(1:3,1:3));
...
JJ(4:6,4:6) = 0.5*(INSECT.J_B + JJ_R(4:6,4:6) + JJ_L(4:6,4:6) + + JJ_A(4:6,4:6));
JJ(4:6,7:9) = JJ_R(4:6,7:9);
JJ(4:6,10:12) = JJ_L(4:6,7:9);
JJ(4:6,13:15) = JJ_A(4:6,7:9);

JJ(7:9,7:9) = 0.5*JJ_R(7:9,7:9);
JJ(10:12,10:12) = 0.5*JJ_L(7:9,7:9);
JJ(13:15,13:15) = 0.5*JJ_A(7:9,7:9);
