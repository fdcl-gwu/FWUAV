...
\begin{itemize}[leftmargin=2.5cm]
    \item[$U(r)\in\Re^3$]  the velocity of the aerodynamic center of the chord $c(r)$ relative to the ambient wind, resolved in $\mathcal{F}_R$
\end{itemize}
...
\begin{align}
dF_L(r) = \frac{1}{2}\rho U(r)^2 C_L(\alpha(r)) c(r) \mathrm{sgn} (e_1^T U(r) e_3^T U(r)) \frac{e_2\times U(r)}{|e_2\times U(r)|} dr.
\end{align}
...
\begin{align}
dF_D(r) = \frac{1}{2}\rho U(r)^2 C_D(\alpha(r)) c(r) \frac{- U(r)}{|U(r)|} dr.
\end{align}
The total lift is obtained by integrating above span-wise for $r\in[0,l]$, where $l>0$ is the span of the right wing, i.e., the length of the right wing along $\mathbf{r}_y$. 
\begin{align}
    F_D = \int_{0}^l dF_D(r),
