...
\end{align}
In short, for the special case of small body velocities, the lift and the drag vector of the right wing resolved in $\matahcal{F}_R$ are given by \eqref{eqn:U_R}--\eqref{eqn:alpha_R}.

\paragraph{Center of Pressure}
